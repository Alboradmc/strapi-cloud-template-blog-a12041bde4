...
///**
// * alb-static-page controller
// */

//const { createCoreController } = require('@strapi/strapi').factories;

//module.exports = createCoreController('api::alb-static-page.alb-static-page');
'use strict';
...
module.exports = createCoreController(
  ...
  ({ strapi }) => ({
    ...
    async find(ctx) {
      ...
      if (slug) {
        // Filter by slug
        const page = await strapi.db.query('api::alb-static-page.alb-static-page').findOne({
          where: { Slug: slug },
          ...queryOptions,
        });
        ...
        // Return all pages
        let data = await strapi.db.query('api::alb-static-page.alb-static-page').findMany(queryOptions);
