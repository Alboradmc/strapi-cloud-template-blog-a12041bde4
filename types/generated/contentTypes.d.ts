...
export interface ApiAlbBlogAlbBlog extends Struct.CollectionTypeSchema {
  collectionName: 'alb_blogs';
  info: {
    displayName: 'ALB-Blog';
    pluralName: 'alb-blogs';
    singularName: 'alb-blog';
  };
  options: {
...
export interface ApiAlbFooterAlbFooter extends Struct.SingleTypeSchema {
  collectionName: 'alb_footers';
  info: {
    displayName: 'ALB-Footer';
    pluralName: 'alb-footers';
    singularName: 'alb-footer';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    appDownload: Schema.Attribute.Component<'shared.app-download', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAlbHeaderAlbHeader extends Struct.SingleTypeSchema {
  collectionName: 'alb_headers';
  info: {
    displayName: 'ALB-Header';
    pluralName: 'alb-headers';
    singularName: 'alb-header';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::alb-header.alb-header'
    >;
    publishedAt: Schema.Attribute.DateTime;
    serviceMenu: Schema.Attribute.Component<'shared.navigation', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    topMenu: Schema.Attribute.Component<'shared.navigation', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAlbHomepageAlbHomepage extends Struct.SingleTypeSchema {
  collectionName: 'alb_homepages';
  info: {
    displayName: 'ALB-Homepage';
    pluralName: 'alb-homepages';
    singularName: 'alb-homepage';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    seoSchema: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAlbPageBannerAlbPageBanner
  extends Struct.CollectionTypeSchema {
  collectionName: 'alb_page_banner';
  info: {
    displayName: 'ALB-Page-Banner';
    pluralName: 'alb-page-banners';
    singularName: 'alb-page-banner';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    mobileBanner: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAlbStaticPageAlbStaticPage
  ...
  info: {
    displayName: 'ALB-Static-Page';
    pluralName: 'alb-static-pages';
    singularName: 'alb-static-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    Details: Schema.Attribute.Component<'shared.title-description', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::alb-blog.alb-blog': ApiAlbBlogAlbBlog;
      ...
      'api::alb-page-banner.alb-page-banner': ApiAlbPageBannerAlbPageBanner;
